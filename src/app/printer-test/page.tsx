...
export default function PrinterTestPage() {
  ...
  const previewCss = `
    ...
    .preview td.queue { font-size:30pt; font-weight:900; line-height:1; }
    .preview td.name  { font-size:18pt; font-weight:900; line-height:1; text-transform:uppercase; }
    .preview td.date  { font-size:11pt; font-weight:700; line-height:1; }
    .preview td.time  { font-size:12pt; font-weight:900; line-height:1; }
    .preview td.phone { font-size:12pt; font-weight:900; line-height:1; }
  `
