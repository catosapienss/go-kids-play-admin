  ...
  return (
    ...
    >
      <div className="space-y-5 max-w-[1600px] mx-auto">
        ...
        {/* ── Kapanış geçmişi — kasa kapanışları ve personel teslimleri tek
               tabloda; `Tür` sütunu / filtresi ikisini ayırt eder. ─────────── */}
        <section aria-label="Kapanış Geçmişi" className="pt-2">
          <ClosingHistory />
        </section>
      </div>
    </MainLayout>
